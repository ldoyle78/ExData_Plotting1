...
## create Plot4 in the png device
png(file = "./Exploratory Data Analysis/ExData_Plotting1/Plot4.png")
  
  ## set parameters
  par(mar = c(5.1, 5.1, 4.1, 2.1), mfrow = c(2,2))

  ## plot 4a code
  with(TwoDaySubset, plot(datetime, Global_active_power, type = "l", ylab = "Global Active Power", xlab = ""))
  ## plot 4b code
  with(TwoDaySubset, plot(datetime, Voltage, type = "l"))
  ...
  legend("topright", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lty = c(1,1,1), cex = 0.95, bty = "n")

  ## plot 4d code
  with(TwoDaySubset, plot(datetime, Global_reactive_power, type ="l"))
