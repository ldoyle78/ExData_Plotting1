...
## create Plot1 in the png device
  png(file = "./Exploratory Data Analysis/ExData_Plotting1/Plot1.png")
  
    par(mar = c(5.1, 5.1, 4.1, 2.1))
    hist(TwoDaySubset$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
